 ...
 *
 * @author YukiLeafX, BlueSheep2804
 * @see [LunaChat Github](https://github.com/ucchyocean/LunaChat/tree/master/src/main/java/com/github/ucchyocean/lc3/japanize/YukiKanaConverter.java)
 */
object RomaToKana {
    private var MAP: ImmutableMap<String, String>
    private val ROMAJI_LIST: Array<String>
    private val HIRAGANA_LIST: Array<String>

    init {
        val builder = ImmutableSortedMap.reverseOrder<String, String>()
        ...
        // 促音を追加する
        for ((romaji, hiragana) in builder.build()) {
            if (canStartFromSokuon(romaji)) {
                builder.put(romaji[0].toString() + romaji, "っ$hiragana")
            }
        }
     ...
     * @since 2.8.10
     */
    fun fixBrackets(text: String?): String {
        val full = arrayOf("（", "）")
        val half = arrayOf("(", ")")
